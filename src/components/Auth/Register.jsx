...
const Register = ({ onHandleRegisterModal }) => {
						...
						<div className='grid grid-cols-2 gap-4'>
							{[
								...
								<div key={name}>
									...
									/>
									{errors[name] && (
										<p className='text-price text-sm'>{errors[name]}</p>
									)}
								</div>
							))}
							<div className='col-span-2'>
								...
								/>
								{errors.image && (
									<p className='text-price text-sm'>{errors.image}</p>
								)}
							</div>
						</div>
