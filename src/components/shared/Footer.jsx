	...
	return (
		<footer className="bg-black dark:bg-transparent text-gray-200 py-12">
			<div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
				<div>
					<h3 className="text-[20px] font-semibold mb-6 text-white">About Company</h3>
				...
				<div>
					<h3 className="text-[20px] font-semibold mb-6 text-white">Vehicles Type</h3>
					<ul className="space-y-2">
						<li>
							<a
								href="#"
				...
				<div>
					<h3 className="text-[20px] font-semibold mb-6 text-white">Quick Links</h3>
					<ul className="space-y-2">
						<li>
							<a
								href="#"
				...
				<div>
					<h3 className="text-[20px] font-semibold mb-6  text-white">Contact Info</h3>
			...
			<div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm">
				<p>Copyright 2024 © Theme Created By Dreams Rent, All Rights Reserved.</p>
			</div>
		</footer>
	);
};
